...
// cpp_oa_spectrum
arma::mat cpp_oa_spectrum(const arma::colvec kn, const double medium, const arma::mat& R, const arma::cx_mat& Alpha, const arma::mat& Angles, const arma::mat& IncidenceNodes, const arma::colvec& IncidenceWeights, const arma::mat& ScatteringNodes, const arma::colvec& ScatteringWeights, const bool full, const bool cg, const bool born, const int maxiter, const double tol, const bool progress);
RcppExport SEXP cda_cpp_oa_spectrum(SEXP knSEXP, SEXP mediumSEXP, SEXP RSEXP, SEXP AlphaSEXP, SEXP AnglesSEXP, SEXP IncidenceNodesSEXP, SEXP IncidenceWeightsSEXP, SEXP ScatteringNodesSEXP, SEXP ScatteringWeightsSEXP, SEXP fullSEXP, SEXP cgSEXP, SEXP bornSEXP, SEXP maxiterSEXP, SEXP tolSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::colvec >::type kn(knSEXP);
    ...
    __result = Rcpp::wrap(cpp_oa_spectrum(kn, medium, R, Alpha, Angles, IncidenceNodes, IncidenceWeights, ScatteringNodes, ScatteringWeights, full, cg, born, maxiter, tol, progress));
    return __result;
END_RCPP
}
// cpp_alpha_blocks
...
arma::cx_mat cpp_interaction_matrix(const arma::mat& R, const double kn, const arma::cx_cube& AlphaBlocks, const bool full);
RcppExport SEXP cda_cpp_interaction_matrix(SEXP RSEXP, SEXP knSEXP, SEXP AlphaBlocksSEXP, SEXP fullSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::mat& >::type R(RSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::cx_cube& >::type AlphaBlocks(AlphaBlocksSEXP);
    Rcpp::traits::input_parameter< const bool >::type full(fullSEXP);
    __result = Rcpp::wrap(cpp_interaction_matrix(R, kn, AlphaBlocks, full));
    return __result;
END_RCPP
}
// cpp_interaction_static
arma::cx_mat cpp_interaction_static(const arma::mat& R);
RcppExport SEXP cda_cpp_interaction_static(SEXP RSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::mat& >::type R(RSEXP);
    __result = Rcpp::wrap(cpp_interaction_static(R));
    return __result;
END_RCPP
}
...
arma::cube cpp_dispersion_spectrum(const arma::colvec kn, const double medium, const arma::mat& R, const arma::cx_mat& Alpha, const arma::mat& Angles, const arma::vec& Incidence, const arma::ivec& Axes, const arma::mat& ScatteringNodes, const arma::vec& ScatteringWeights, const int polarisation, const bool full, const bool cg, const bool born, const int maxiter, const double tol, const bool progress);
RcppExport SEXP cda_cpp_dispersion_spectrum(SEXP knSEXP, SEXP mediumSEXP, SEXP RSEXP, SEXP AlphaSEXP, SEXP AnglesSEXP, SEXP IncidenceSEXP, SEXP AxesSEXP, SEXP ScatteringNodesSEXP, SEXP ScatteringWeightsSEXP, SEXP polarisationSEXP, SEXP fullSEXP, SEXP cgSEXP, SEXP bornSEXP, SEXP maxiterSEXP, SEXP tolSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::colvec >::type kn(knSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type tol(tolSEXP);
    Rcpp::traits::input_parameter< const bool >::type progress(progressSEXP);
    __result = Rcpp::wrap(cpp_dispersion_spectrum(kn, medium, R, Alpha, Angles, Incidence, Axes, ScatteringNodes, ScatteringWeights, polarisation, full, cg, born, maxiter, tol, progress));
    return __result;
END_RCPP
}
// cpp_incident_field
...
// cpp_iterate_field
arma::colvec cpp_iterate_field(const arma::mat& R, const double kn, const double medium, const arma::cx_mat& Ein, const arma::cx_cube& AlphaBlocks, arma::cx_mat& Eloc, arma::cx_mat& P);
RcppExport SEXP cda_cpp_iterate_field(SEXP RSEXP, SEXP knSEXP, SEXP mediumSEXP, SEXP EinSEXP, SEXP AlphaBlocksSEXP, SEXP ElocSEXP, SEXP PSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::mat& >::type R(RSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::cx_mat& >::type Ein(EinSEXP);
    Rcpp::traits::input_parameter< const arma::cx_cube& >::type AlphaBlocks(AlphaBlocksSEXP);
    Rcpp::traits::input_parameter< arma::cx_mat& >::type Eloc(ElocSEXP);
    Rcpp::traits::input_parameter< arma::cx_mat& >::type P(PSEXP);
    __result = Rcpp::wrap(cpp_iterate_field(R, kn, medium, Ein, AlphaBlocks, Eloc, P));
    return __result;
END_RCPP
}
// cpp_oa_oos
...
// cpp_oa_spectrum_oos
arma::mat cpp_oa_spectrum_oos(const arma::colvec kn, const double medium, const arma::mat& R, const arma::cx_mat& Alpha, const arma::mat& Angles, const arma::mat& IncidenceNodes, const arma::colvec& IncidenceWeights, const arma::mat& ScatteringNodes, const arma::colvec& ScatteringWeights, const bool full, const int maxiter, const double tol, const bool progress);
RcppExport SEXP cda_cpp_oa_spectrum_oos(SEXP knSEXP, SEXP mediumSEXP, SEXP RSEXP, SEXP AlphaSEXP, SEXP AnglesSEXP, SEXP IncidenceNodesSEXP, SEXP IncidenceWeightsSEXP, SEXP ScatteringNodesSEXP, SEXP ScatteringWeightsSEXP, SEXP fullSEXP, SEXP maxiterSEXP, SEXP tolSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::colvec >::type kn(knSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type tol(tolSEXP);
    Rcpp::traits::input_parameter< const bool >::type progress(progressSEXP);
    __result = Rcpp::wrap(cpp_oa_spectrum_oos(kn, medium, R, Alpha, Angles, IncidenceNodes, IncidenceWeights, ScatteringNodes, ScatteringWeights, full, maxiter, tol, progress));
    return __result;
END_RCPP
}
// cpp_dispersion_spectrum_oos
arma::cube cpp_dispersion_spectrum_oos(const arma::colvec kn, const double medium, const arma::mat& R, const arma::cx_mat& Alpha, const arma::mat& Angles, const arma::vec& IncidenceNodes, const arma::ivec& IncidenceAxes, const arma::mat& ScatteringNodes, const arma::colvec& ScatteringWeights, const int polarisation, const bool full, const int maxiter, const double tol, const bool progress);
RcppExport SEXP cda_cpp_dispersion_spectrum_oos(SEXP knSEXP, SEXP mediumSEXP, SEXP RSEXP, SEXP AlphaSEXP, SEXP AnglesSEXP, SEXP IncidenceNodesSEXP, SEXP IncidenceAxesSEXP, SEXP ScatteringNodesSEXP, SEXP ScatteringWeightsSEXP, SEXP polarisationSEXP, SEXP fullSEXP, SEXP maxiterSEXP, SEXP tolSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< const arma::colvec >::type kn(knSEXP);
    ...
    Rcpp::traits::input_parameter< const arma::cx_mat& >::type Alpha(AlphaSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type Angles(AnglesSEXP);
    Rcpp::traits::input_parameter< const arma::vec& >::type IncidenceNodes(IncidenceNodesSEXP);
    Rcpp::traits::input_parameter< const arma::ivec& >::type IncidenceAxes(IncidenceAxesSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type ScatteringNodes(ScatteringNodesSEXP);
    Rcpp::traits::input_parameter< const arma::colvec& >::type ScatteringWeights(ScatteringWeightsSEXP);
    Rcpp::traits::input_parameter< const int >::type polarisation(polarisationSEXP);
    Rcpp::traits::input_parameter< const bool >::type full(fullSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type tol(tolSEXP);
    Rcpp::traits::input_parameter< const bool >::type progress(progressSEXP);
    __result = Rcpp::wrap(cpp_dispersion_spectrum_oos(kn, medium, R, Alpha, Angles, IncidenceNodes, IncidenceAxes, ScatteringNodes, ScatteringWeights, polarisation, full, maxiter, tol, progress));
    return __result;
END_RCPP
}
// sample_random
