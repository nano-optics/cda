In this example the optical acitivity of a chiral dimer of axi-symmetric nanoparticles is investigated. First, we visualise the parametrisation of such a dimer with the inter-particle separation, the dihedral angle, and one additional angle for each particle.
